...
In the survey, you will have two quantitative tasks to complete, and a few optional qualitative questions to answer. This metholod of evaluation is based on the work of Gardner (2003) [[1]](#references) and is designed to be fair and effective in assessing individual contributions to group projects.
...
2. Average the ratings for each member of the team (*excluding* self)
3. If the team has more or less than 4 members:
