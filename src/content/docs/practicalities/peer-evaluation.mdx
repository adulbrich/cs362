...
In the survey, you will have two quantitative tasks to complete, and a few optional qualitative questions to answer. This metholod of evaluation is based on the work of Gardner (2003)[^1] and is designed to be fair and effective in assessing individual contributions to group projects.
