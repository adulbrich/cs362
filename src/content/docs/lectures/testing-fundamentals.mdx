...
{/* IMPROVE: Add a brief explanation of environments (development, staging, production) and how testing fits into each. */}
{/* TODO: add something about environments */}
{/* IMPROVE: Add a brief explanation of xUnit and its significance in the history of automated testing. */}
...
{/* IMPROVE: Add a note about Grey Box Testing as a hybrid approach. */}
...
{/* IMPROVE: Add a section on Regression Testing and its importance in preventing old bugs from reappearing. */}
...
<div class="flex flex-col items-center w-full max-w-lg">
  <div class="bg-red-500 text-gray-800 text-center py-4 w-1/3 border-b-2 border-red-700 shadow-md">
      <h4 class="text-base font-semibold text-gray-800">E2E Tests</h4>
  ...
  <div class="bg-yellow-400 text-gray-800 text-center py-6 w-2/3 border-b-2 border-yellow-600 shadow-md">
      <h4 class="text-base font-semibold text-gray-800">Integration Tests</h4>
      <p class="text-sm">Connecting the dots, moderately complex and expensive, slower</p>
  </div>
  <div class="bg-green-500 text-gray-800 text-center py-8 w-full border-b-2 border-green-700 shadow-md">
      <h4 class="text-base font-semibold text-gray-800">Unit Tests</h4>
