...
*Courtesy of [Kent C. Dodds](https://kentcdodds.com/blog/write-tests) (h/t to [Martin Fowler](https://martinfowler.com/bliki/TestPyramid.html) and the [Google Testing Blog](https://testing.googleblog.com/2015/04/just-say-no-more-end-to-end-tests.html))*
