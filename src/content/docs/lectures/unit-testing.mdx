...
We already briefly discussed 1, 2, and 3. Let's clarify them and look at 4 in more detail.
...
We'll discuss a few other common antipatterns below.
...
{/* FIX: This section seems incomplete. Consider adding an example of interaction testing (e.g., checking if a function was called) vs state testing, or expanding on why state testing is preferred in this context. */}
