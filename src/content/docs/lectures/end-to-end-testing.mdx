...
In this lecture, we'll work with a simple Todo application built with [Vite](https://vite.dev/) and [Svelte](https://svelte.dev/). This application is a great example of a web app that can be tested end-to-end.
